...
def process_face_shape(image_path):
  ...
  face_cascade_path = r"FaceShape/haarcascade_frontalface_default.xml"
  #.dat file for detecting facial landmarks
  #download file path = http://dlib.net/files/shape_predictor_68_face_landmarks.dat.bz2
  predictor_path = r"FaceShape/shape_predictor_68_face_landmarks.dat"
  ...
  for i in range(1):
    if similarity<10 or (similarity > 34 and similarity < 35) :
      if angle<170:
        # print('Square')
        return 'Square'
      else:
